...
public class FindSeoulActivity extends AppCompatActivity {
    ...
    private void getGPS() {
        ...
        if (Build.VERSION.SDK_INT >= 23 &&
            ...
            ActivityCompat.requestPermissions(FindSeoulActivity.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION},
    ...
    public void YesButtonClicked(View view) {
        ...
        Intent intent = new Intent(getApplicationContext(), ListViewSeoulActivity.class);
