...
public class FindBusStationGGD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_bus_station_ggd);
        ...
        busStation = findViewById(R.id.station_name_ggd);

        nobtn = findViewById(R.id.yesbtn_ggd);
        yesbtn = findViewById(R.id.nobtn_ggd);
        reDobtn = findViewById(R.id.reDobtn_ggd);
    ...
    public void YesButtonClicked(View view) {
        ...
        Intent intent = new Intent(getApplicationContext(), ChooseActivityGGD.class);
